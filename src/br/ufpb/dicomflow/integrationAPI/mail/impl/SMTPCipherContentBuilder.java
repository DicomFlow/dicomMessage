...
public class SMTPCipherContentBuilder implements MailContentBuilderIF {
	...
	public Message buildContent(Message message, ServiceIF service) {
		...
		try {
			...
			multipart = new MimeMultipart("multipart/encrypted; protocol=\"application/cipher-encrypted\"");
            
            MimeBodyPart attachment0 = new MimeBodyPart();
            
            attachment0.setContent(str.toString(),"application/cipher-encrypted");
	...
	public int getType(){
		return MailContentBuilderIF.SMTP_CIPHER_CONTENT_STRATEGY;
	}
