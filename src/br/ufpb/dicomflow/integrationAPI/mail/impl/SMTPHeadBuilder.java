...
public class SMTPHeadBuilder implements MailHeadBuilderIF {
	...
	public Map<String, Object> getMailXTags(Message message) {
		...
		map.put(MailXTags.FROM, getHeaderValue(message, MailXTags.FROM));
		map.put(MailXTags.TO, getHeaderValue(message, MailXTags.TO));
		map.put(MailXTags.SUBJECT, getHeaderValue(message, MailXTags.SUBJECT));
		map.put(MailXTags.DATE, getHeaderValue(message, MailXTags.DATE));
		return map;
	}
